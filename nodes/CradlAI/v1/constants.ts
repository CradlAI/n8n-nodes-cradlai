...
export const PROPERTY_NAME_SHOW_ADVANCED_OPTIONS = 'showAdvancedOptions';
export const PROPERTY_NAME_USE_PREVIOUSLY_UPLOADED_DOCUMENT_FOR_TESTING = 'usePreviouslyUploadedDocumentForTesting';
...
export const DEFAULT_VALUE_SHOW_ADVANCED_OPTIONS = false;
export const DEFAULT_VALUE_USE_PREVIOUSLY_UPLOADED_DOCUMENT_FOR_TESTING = false;
